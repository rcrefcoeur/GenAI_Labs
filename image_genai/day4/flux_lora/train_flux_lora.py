...
# --- Minimal AppConfig (kept for evaluation + W&B) ---

@dataclass
class AppConfig(SharedConfig):
    """Configuration information for inference/evaluation."""
    num_inference_steps: int = 25
    guidance_scale: float = 6

# --- Web UI disabled (FastAPI / Gradio removed for local execution safety) ---
