...
# ---------------
variant_stats = pd.read_csv("analysis/variant_stats.csv", index_col=0)
...
plt.tight_layout()
plt.savefig("analysis/figures/robust_variants.png")
plt.close()



# ------------------
residue_stats = pd.read_csv("analysis/residue_stats.csv", index_col=0)
...
plt.gca().invert_yaxis()
plt.tight_layout()
plt.savefig("analysis/figures/dominant_residues.png")
plt.close()
...
scenario_residue = pd.read_csv(
    "analysis/scenario_residue_table.csv", index_col=0
)
...
plt.tight_layout()
plt.savefig("analysis/figures/scenario_residue_heatmap.png")
plt.close()
# -----------------
...
scenario_variant = pd.read_csv(
    "analysis/scenario_variant_table.csv", index_col=0
)
...
plt.tight_layout()
plt.savefig("analysis/figures/scenario_similarity_heatmap.png")
plt.close()
